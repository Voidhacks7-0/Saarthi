...
export default function FacultyPendingApprovalPage() {
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid gap-6">
          ...
          <div className="bg-gradient-to-br from-accent/10 to-primary/10 border border-accent/30 rounded-xl p-6 sm:p-8 text-center">
            ...
            <h1 className="text-3xl font-bold text-foreground mb-2">Faculty Profile Under Review</h1>
            <p className="text-muted-foreground mb-4">
              Your faculty profile has been submitted successfully for admin approval. This typically takes 24-48 hours.
            </p>
            ...
            <div className="space-y-3 text-left bg-card border border-border rounded-lg p-6 mb-6">
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-accent mt-1 flex-shrink-0" />
                <div>
                  <p className="font-semibold text-foreground">{user?.courses?.length || 0} Courses Teaching</p>
            ...
            <p className="text-sm text-muted-foreground mb-6">
              We will automatically refresh this page and redirect you to your faculty dashboard once your profile is
              approved. You can also check back later by signing in.
            </p>
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex gap-3">
                ...
                <span>Admin will review your faculty profile and credentials</span>
              </li>
              <li className="flex gap-3">
                <span className="text-accent font-bold">2.</span>
                <span>Verification includes checking department, designation, and courses</span>
              </li>
              <li className="flex gap-3">
                <span className="text-accent font-bold">3.</span>
                <span>Once approved, you'll automatically be redirected to your faculty dashboard</span>
              </li>
              <li className="flex gap-3">
                <span className="text-accent font-bold">4.</span>
                <span>You can then manage courses, create announcements, and interact with students</span>
              </li>
              <li className="flex gap-3">
